  ...
  return (
    ...
    <div className="hero-section">
      <section className="content-container">
       ...
       <div className="para">
        <p className="p_text">
          API managment tool for crafting, overseeing, securing API accross
          varied usecases, enviroment, and scales.
        </p>
       </div>
    ...
    <section className="powerControl">
        <div className="power-head-div">
            <h2 className="power-heading">
                <span className="power-heading-span">Powerfull Controls</span>
            </h2>
        </div>
        <div className="power-des-div">
            <p className="power-des">Fuel your curiosity, expand your horizons, and achieve greatness by joining a vibrant community of learners.</p>
        </div>
        <div className="breaker"></div>
        <figure className="power-fig">
            <div className="power-fig-div">
                <img  decoding="async" 
    sizes="740px" className="power-fig-img" srcSet={`${power}?scale-down-to=512 512w, ${power}?scale-down-to=1024 1024w, ${power}?scale-down-to=2048 2048w, ${power} 3361w`}
      src={`${power}?scale-down-to=2048`} alt="A visual from the dashboard of Solaris" />
            </div>
        </figure>
    </section>
    </>
